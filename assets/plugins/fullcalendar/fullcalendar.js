...
var TimeGrid = Grid.extend({
	...
	// A `startOfDayDate` must be given for avoiding ambiguity over how to treat micight.
...
TimeGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		if (view.isMultiDayEvent(event)) { // if the event appears to span more than one day...
			...
			// That would appear as micight-micight and would look dumb.
			// Otherwise, display the time text for the *segment's* times (like 6pm-micight or micight-10am)
