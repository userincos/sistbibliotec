      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="ci" >Carnet del lector:</label>
                    <div class="col-sm-4">
                        <input type="hidden" name="idLector">
                        <input type="text" class="form-control" id="ci" placeholder="ci" required/>
                    </div>
                    <button type="button" id="btn-comprobarci" class="btn btn-warning btn-flat"> <i class="fa fa-search" aria-hidden="true"></i> Comprobar</button>
